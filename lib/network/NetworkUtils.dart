...
Uri buildBaseUrl(String endPoint) {
  try {
    if (endPoint.startsWith('http')) {
      ...
      if (url.host.isEmpty) {
        throw FormatException('No host specified in URI', endPoint);
      }
      log('URL: ${url.toString()}');
      return url;
    } else {
      // For relative URLs, append to the base URL
      String fullUrl = '$mBaseUrl$endPoint';
    ...
    // Fallback to a default URL with proper host
    return Uri.parse('$DOMAIN_URL/api/$endPoint');
  }
}
